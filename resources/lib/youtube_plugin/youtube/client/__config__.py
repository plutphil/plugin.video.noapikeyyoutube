...
"""
    ...
    Copyright (C) 2017-2018 plugin.video.noapikeyyoutube
...
__context = __Context(plugin_id='plugin.video.noapikeyyoutube')
...
class APICheck(object):
    ...
    def _on_init(self):
        ...
        if updated_hash:
            ...
            self._context.execute('RunPlugin(plugin://plugin.video.noapikeyyoutube/sign/out/?confirmed=true)')
        else:
