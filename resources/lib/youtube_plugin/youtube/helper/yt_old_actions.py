...
def _process_play_video(provider, context, re_match):
    """
    plugin://plugin.video.noapikeyyoutube/?action=play_video&videoid=[ID]
    """
...
def _process_play_all(provider, context, re_match):
    """
    plugin://plugin.video.noapikeyyoutube/?path=/root/video&action=play_all&playlist=PL8_6CHho8Tq4Iie-oNxb-g0ECxIhq3CxW
    plugin://plugin.video.noapikeyyoutube/?action=play_all&playlist=PLZRRxQcaEjA5fgfW3a3Q0rzm6NgbmICtg&videoid=qmlYe2KS0-Y
    """
